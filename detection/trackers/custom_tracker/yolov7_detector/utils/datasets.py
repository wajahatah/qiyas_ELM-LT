...
from detection.trackers.custom_tracker.yolov7_detector.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from detection.trackers.custom_tracker.yolov7_detector.utils.torch_utils import torch_distributed_zero_first
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        # # print("img", img)
        # print(labels_out)
        # print(self.img_files[index], shapes)
