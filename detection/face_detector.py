...
from detection.models.common import Conv
from detection.models.yolo import Model
from detection.utils.datasets import letterbox
from detection.utils.preprocess_utils import align_faces
from detection.utils.general import check_img_size, non_max_suppression_face, \
    scale_coords,scale_coords_landmarks,filter_boxes

class YoloDetector:
    def __init__(self, weights_name='yolov5l_state_dict.pt', config_name='yolov5l.yaml', device='cuda:0', min_face=100, target_size=None, frontal=False):
            """
