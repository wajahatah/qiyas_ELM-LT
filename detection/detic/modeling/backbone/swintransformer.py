...
from detection.third_party.CenterNet2.centernet.modeling.backbone.fpn_p5 import LastLevelP6P7_P5
from detection.third_party.CenterNet2.centernet.modeling.backbone.bifpn import BiFPN
