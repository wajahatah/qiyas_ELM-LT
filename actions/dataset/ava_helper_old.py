...
def read_exclusions(exclusions_file):
    ...
    """
    exclusions_file = '/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/ava_train_excluded_timestamps_v2.2.csv'
...
def load_image_lists(frames_dir, frame_list, is_train):
    ...
    #print(image_paths)
    print('Number of videos: ', len(image_paths))
...
def load_boxes_and_labels(gt_box_list, exclusion_file, is_train=False, full_test_on_val=False):
    ...
    ann_filename = "/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/train_gt_box_list.csv"
...
def get_max_objs(keyframe_indices, keyframe_boxes_and_labels):
    ...
    # return max_objs
    return 100 #### MODIFICATION FOR NOW! TODO: FIX LATER!
