...
class AVA_Dataset(Dataset):
    def __init__(self,
        ...
        # self.frames_dir = "/home/haithemt/actionrecognition/data/AVA_Dataset/frames/"#os.path.join(data_root, cfg['frames_dir'])
        self.frames_dir = "C:/OsamaEjaz/YowoV2_train_test/data_new/frames/"
        # self.frame_list = "/home/haithemt/actionrecognition/data/AVA_Dataset/frame_lists/" #os.path.join(data_root, cfg['frame_list'])
        self.frame_list = "C:/OsamaEjaz/YowoV2_train_test/data_new/AVA_Dataset/frame_lists/" #os.path.join(data_root, cfg['frame_list'])
        # self.annotation_dir = "/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/"#os.path.join(data_root, cfg['annotation_dir'])
        self.annotation_dir = "C:/OsamaEjaz/YowoV2_train_test/data_new/AVA_Dataset/annotations/"#os.path.join(data_root, cfg['annotation_dir'])
        # self.labelmap_file = "/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/action_list.pbtxt"#os.path.join(data_root, cfg['annotation_dir'], cfg['labelmap_file'])
        self.labelmap_file = "C:/OsamaEjaz/YowoV2_train_test/data_new/AVA_Dataset/annotations/action_list.pbtxt"#os.path.join(data_root, cfg['annotation_dir'], cfg['labelmap_file'])
        if is_train:
            # self.gt_box_list = "/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/train_gt_box_list.csv"#os.path.join(self.annotation_dir, cfg['train_gt_box_list'])
            # self.exclusion_file = "/home/haithemt/actionrecognition/data/AVA_Dataset/annotations/ava_train_excluded_timestamps_v2.2.csv"#os.path.join(self.annotation_dir, cfg['train_exclusion_file'])
            self.gt_box_list = "C:/OsamaEjaz/YowoV2_train_test/data_new/AVA_Dataset/annotations/train_gt_box_list.csv"#os.path.join(self.annotation_dir, cfg['train_gt_box_list'])
            self.exclusion_file = "ava_train_excluded_timestamps_v2.2.csv"#os.path.join(self.annotation_dir, cfg['train_exclusion_file'])      
        
        else:
            self.gt_box_list = "/C:/OsamaEjaz/YowoV2_train_test/data_new/AVA_Dataset/annotations/val_gt_box_list.csv"#os.path.join(self.annotation_dir, cfg['val_gt_box_list'])
            self.exclusion_file = "ava_val_excluded_timestamps_v2.2.csv"#os.path.join(self.annotation_dir, cfg['val_exclusion_file'])
    ...
    def _load_data(self):
        ...
        #print(self.gt_box_list)
        #print(self.exclusion_file)
...
if __name__ == '__main__':
    ...
    sampling_rate = 1
    dataset_config = {
        'data_root': '/home/haithemt/actionrecognition/data/',
        'frames_dir': 'frames/',
        'frame_list': 'frame_lists/',
        'annotation_dir': 'annotations/',
        'train_gt_box_list': 'train_gt_box_list.csv',
        'val_gt_box_list': 'val_gt_box_list.csv',
        'train_exclusion_file': 'ava_train_excluded_timestamps_v2.2.csv',
        'val_exclusion_file': 'ava_val_excluded_timestamps_v2.2.csv',
        'labelmap_file': 'action_list.pbtxt',
    }
    trans_config = {
        'jitter': 0.2,
        'hue': 0.1,
    ...
    #train_transform = BaseTransform(img_size=img_size)
    ...
    for i in range(20):
        ...
        for box, cls_id in zip(bboxes, labels):
            if int(torch.argmax(cls_id).numpy())+1 ==10:
              x1, y1, x2, y2 = box
              x1 = int(x1 * W)
              y1 = int(y1 * H)
              x2 = int(x2 * W)
              ...
              cv2.putText(key_frame, str(int(torch.argmax(cls_id).numpy())+1), (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 2)
        
        # cv2 show
        cv2.imwrite(f'debug/frame_{counter}.jpg', key_frame)
        counter+=1
